            ...
            <div className="pt-12 w-full lg:w-1/2">
                {checklistItems.map((checklistItems,index)=>(
                    <div key={index} className="flex mb-12">
                        <div className="text-green-400 mx-6 bg-neutral-900 h-10 w-10 justify-center items-center rounded-full">
                            <CheckCircle2/>
                        </div>    
                        <div>
                            <h5 className="mt-1 mb-2 text-xl">{checklistItems.title}</h5>
